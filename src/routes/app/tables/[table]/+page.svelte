<script lang="ts">
	...
	function getActionsForRow(row: { id?: string; created_at?: string; first_name?: string }) {
	...
	function handleCopy(row: { id?: string; first_name?: string }) {
	...
	function handleEdit(row: { id?: string; [key: string]: any }) {
		/* ... */
	}
